...
XCVAR_DEF( bot_custom_nav_enable,		"1",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
XCVAR_DEF( bot_custom_reverse_yaw_chance,	"10",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
