...
XCVAR_DEF( bot_navigation,				"1",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
XCVAR_DEF( bot_yawswitch,				"10",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
...
XCVAR_DEF( bot_targetdistance,			"4096",		NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
XCVAR_DEF( g_newBotAITargetDistance,	"4096",		NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_lowhangingfruitHP,		"40",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
XCVAR_DEF( bot_lowhanginfruitDistance,	"1024",		NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
XCVAR_DEF( bot_aggressionbias,			"0",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
...
XCVAR_DEF( bot_antidrainbias,			"0",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
XCVAR_DEF( bot_fanbias,					"0",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
XCVAR_DEF( bot_drainbias,				"0",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
...
XCVAR_DEF( bot_strafeduration,			"50",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
XCVAR_DEF( bot_ptk_FPbias,				"0",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
XCVAR_DEF( bot_ptk_enemyhpbias,			"0",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
XCVAR_DEF( bot_ptk_aggressionbias,		"0",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
