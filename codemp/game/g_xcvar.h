...
// Shared tactical range bands for per-attack range weighting. Distances <= bot_rangeshort are
// short, distances <= bot_rangemedium are medium, and anything beyond bot_rangemedium is long.
XCVAR_DEF( bot_rangeshort,				"160",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_rangemedium,				"320",			NULL,				CVAR_ARCHIVE,									qtrue )
...
XCVAR_DEF( bot_aggressionBias,			"0",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_healthbias,				"0",			NULL,				CVAR_ARCHIVE,									qtrue )
...
// Per-band range weighting (percent scaler, 100 = legacy/neutral, 0 = disable in that band)
// for attack selection and saber attack commitment.
XCVAR_DEF( bot_pullweight_short,		"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_pullweight_medium,		"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_pullweight_long,			"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_ptkweight_short,			"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_ptkweight_medium,		"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_ptkweight_long,			"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_saberthrowweight_short,	"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_saberthrowweight_medium,	"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_saberthrowweight_long,	"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_lightningweight_short,	"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_lightningweight_medium,	"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_lightningweight_long,	"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_gripweight_short,		"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_gripweight_medium,		"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_gripweight_long,			"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_drainweight_short,		"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_drainweight_medium,		"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_drainweight_long,		"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_saberattackweight_short,	"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_saberattackweight_medium,"100",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_saberattackweight_long,	"100",			NULL,				CVAR_ARCHIVE,									qtrue )
