...
XCVAR_DEF( bot_pullweight_short,		"90",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_pullweight_medium,		"140",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_pullweight_long,			"115",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_ptkweight_short,			"85",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_ptkweight_medium,		"150",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_ptkweight_long,			"110",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_saberthrowweight_short,	"45",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_saberthrowweight_medium,	"125",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_saberthrowweight_long,	"165",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_lightningweight_short,	"40",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_lightningweight_medium,	"150",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_lightningweight_long,	"125",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_gripweight_short,		"170",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_gripweight_medium,		"90",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_gripweight_long,			"35",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_drainweight_short,		"70",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_drainweight_medium,		"120",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_drainweight_long,		"150",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_saberattackweight_short,	"155",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_saberattackweight_medium,"95",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_saberattackweight_long,	"40",			NULL,				CVAR_ARCHIVE,									qtrue )
