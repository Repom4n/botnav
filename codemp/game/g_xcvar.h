...
// How long (ms) our bot holds each upward jerk of the gripkick sequence before either
// re-rolling the next jerk or going back for another flipkick attempt. Mild per-jerk
// variance is applied on top of this base value to keep the hold unpredictable.
XCVAR_DEF( bot_gripdwell,				"400",			NULL,				CVAR_ARCHIVE,									qtrue )
