...
XCVAR_DEF( bot_custom_probe_distance,		"16",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_custom_trace_half_width,	"15",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( bot_custom_trace_height,		"32",			NULL,				CVAR_ARCHIVE,									qtrue )
